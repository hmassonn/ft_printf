...
int		main()
{
	...
	/* Pourquoi les ft_printf de ft_printf ? printf renvoie le nombre de caractere qu'il a affiche. Ainsi, on peut verifier si on renvoie bien le bon nombre.
	...
	/* Ces tests la ne fonctionnent pas avec le vrai. */
